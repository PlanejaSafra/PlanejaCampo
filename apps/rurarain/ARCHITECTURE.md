# Architecture (`apps/rurarain`)

This document objectively describes the files and components of the **RuraRain** application (formerly PlanejaChuva).
