            ...
            itemBuilder: (context, index) {
              ...
              return CustomCard(
                ...
                child: ListTile(
                  ...
                  subtitle:
                      Text('${entrega.itens.length} ${l10n.partnersAttended}'),
                  trailing: Column(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
                '${l10n.listaEntregasWeight}: ${entrega.pesoTotalGeral.toStringAsFixed(1)} kg'),
            const SizedBox(height: 16),
            Text(l10n.parceirosTitle,
                style: const TextStyle(fontWeight: FontWeight.bold)),
            ...entrega.itens.map((i) => Text(
                '- ${l10n.unknownPartner}: ${i.pesoTotal.toStringAsFixed(1)} kg')),
