          ...
          child: Column(
            ...
            children: [
              ...
              _ProfileCard(
                ...
                onTap: () {
                  debugPrint('[ProfileSelection] Selected Comprador');
              ...
              _ProfileCard(
                ...
                onTap: () {
                  debugPrint('[ProfileSelection] Selected Produtor');
              ...
              _ProfileCard(
                ...
                onTap: () {
                  debugPrint('[ProfileSelection] Selected Sangrador');
              ...
              FilledButton(
                onPressed: _selectedType != null && !_isLoading
                    ? () {
                        debugPrint('[ProfileSelection] Continue pressed');
                        _saveProfile();
                      }
                    : null,
